// MicroTimer.h is a copy of SimpleTimer.h
// Showever it uses micros() instead of millis()
...
public:
    ...
    // call function f every d microseconds
    int setInterval(long d, timer_callback f);

    // call function f once after d microseconds
    int setTimeout(long d, timer_callback f);

    // call function f every d microseconds for n times
...
private:
    ...
    // value returned by the micros() function
    // in the previous run() call
    unsigned long prev_micros[MAX_TIMERS];
