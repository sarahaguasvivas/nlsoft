...
from controller.lstm_model import LSTMNeuralNetworkPredictor
...
NNP = LSTMNeuralNetworkPredictor(model_file = model_filename,
                                      N1 = 0, N2 = 2, Nu = 1,
                                      nd = 1, dd = 1, K = 1,
                                      Q = np.array([[100., 0., 0],
                                                    [0., 1000., 0],
...
try:
    for e in range(NUM_EXPERIMENTS):
        ...
        for n in range(NUM_TIMESTEPS):
            ...
            NNP.input_vector = neural_network_input
