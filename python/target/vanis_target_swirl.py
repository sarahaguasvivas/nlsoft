...
class VanisSwirl():
    ...
    def spin(self, timestep, n1, n2, dims):
        ...
        for _ in range(n1, n2):
            x = self.reference_data[timestep + i, 0] + self.neutral_point[0]
            y = self.reference_data[timestep + i, 1] + self.neutral_point[1]
            z = self.reference_data[timestep + i, 2] + self.neutral_point[2]
            target[i, :] = [x,y,z]
            i+=1
        return target
